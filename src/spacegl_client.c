        ...
        if (type == PKT_QUERY_KEY) {
            ...
            if (g_shared_state) {
                ...
                for (int o=0; o < current_state.object_count; o++) {
                    ...
                    g_shared_state->objects[o].vx = current_state.objects[o].vx;
                    g_shared_state->objects[o].vy = current_state.objects[o].vy;
                    g_shared_state->objects[o].vz = current_state.objects[o].vz;
